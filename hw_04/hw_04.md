...
![](hw_04_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-3-1.png) As suggested by the prompt, I plotted the life expectancies of the countries against each other using the pairs function (I couldn't find a way to do this in ggplot)
